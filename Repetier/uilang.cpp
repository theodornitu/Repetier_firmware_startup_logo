...
/*** MariusG Addon ***/
TRANS(UI_TEXT_MODE_FFF_EN);
TRANS(UI_TEXT_MODE_LASER_EN);
TRANS(UI_TEXT_MODE_CNC_EN);
TRANS(UI_TEXT_LASER_READY_EN);
TRANS(UI_TEXT_CNC_READY_EN);
TRANS(UI_TEXT_AUTOCALIB_EN);
TRANS(UI_TEXT_DISTORTION_EN);
/***End of Addon ***/
...
PGM_P const translations_en[NUM_TRANSLATED_WORDS] PROGMEM = {
 ...
 FUI_TEXT_PRINTNAME_EN,
  /*** MariusG Addon ***/
 FUI_TEXT_MODE_FFF_EN,
 FUI_TEXT_MODE_LASER_EN,
 FUI_TEXT_MODE_CNC_EN,
 FUI_TEXT_LASER_READY_EN,
 FUI_TEXT_CNC_READY_EN,
 FUI_TEXT_AUTOCALIB_EN,
 FUI_TEXT_DISTORTION_EN
 /*** End of addon ***/
};
