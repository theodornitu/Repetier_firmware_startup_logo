...
/***   MariusG Addon 	***/
//UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_distortion, UI_TEXT_DISTORTION_ID, UI_ACTION_DISTORTION)
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_autocalib, UI_TEXT_AUTOCALIB_ID, UI_ACTION_AUTOCALIB)
/*UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_set_mode_fff, UI_TEXT_MODE_FFF_ID, UI_ACTION_FFF_MODE)
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_set_mode_laser, UI_TEXT_MODE_LASER_ID, UI_ACTION_LASER_MODE)
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_set_mode_cnc, UI_TEXT_MODE_CNC_ID, UI_ACTION_CNC_MODE)
*/
/***   End of Addon  	***/
...
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY UI_CHANGE_FIL_ENT,&ui_menu_quick_autocalib,/*&ui_menu_quick_distortion,&ui_menu_quick_set_mode_fff,&ui_menu_quick_set_mode_laser,&ui_menu_quick_set_mode_cnc,*/&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_quick_cooldown,/*&ui_menu_quick_origin,*/&ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
// End
